...
public class Demo {
    ...
    // Create a Deferred Register to hold Items which will all be registered under the "demo" namespace
    ...
    // Creates a new BlockItem with the id "demo:example_block", combining the namespace and path
